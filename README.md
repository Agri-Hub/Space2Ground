...
### Usage example
A jupyter notebook with the implementation using Space2Ground dataset described in our [publication](#space2ground_paper) can be also found as part of this repo (file [Space2Ground_use_case.ipynb](Space2Ground_use_case.ipynb))
